<div>
   <div class="form-group"> &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp 
      <label for="TipoContrato"> Tipo de Contrato </label> &nbsp 
         <select name="TipoContrato" class="form-control" id="TipoContrato" value="{{ isset($laborales->TipoContrato)?$laborales->TipoContrato:'' }}">

        ...
        <form action="{{ url("/persona/$id/laboral") }}" method="post">
            ...
            <div class="row justify-content-center p-3" style="max-width: 600px">   
                ...
                <div class="col-12 col-sm-6">
                    ...
                    <input type="date" class="form-control" aria-label="FechaEgreso" id="FechaEgreso" name="FechaEgreso"
                ...
                <script>
                    $(document).ready(function () {
                        // Agrega un evento change al campo "Tipo de Contrato"
                        $('#TipoContrato').on('change', function () {
                            var selectedValue = $(this).val();
                            if (selectedValue === 'Contratado') {
                                // Muestra el campo "Fecha de Egreso" si se selecciona "Contratado"
                                $('#FechaEgreso').show();
                            } else {
                                // Oculta el campo "Fecha de Egreso" en caso contrario
                                $('#FechaEgreso').hide();
                            }
                        });
                    });

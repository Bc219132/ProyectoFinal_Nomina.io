                        ...
                        <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list"
                            ...
                            <a class="dropdown-item preview-item">
                                <div class="preview-thumbnail">
                                    <img src="{{ asset('assets/images/faces/face.jpg') }}" alt="image"
                                        class="profile-pic">
                                </div>
                                <div
                ...
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="ui-basic">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link" href="{{ url('persona') }}"> Listado y
                                        Registro </a></li>
                                <li class="nav-item"> <a class="nav-link" href="{{ url('laborales') }}"> Proceso
                                        Datos Laborales </a></li>
                            </ul>
                        </div>
                    </li>
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="ui-basic2">
                            <ul class="nav flex-column sub-menu">
                                ...
                                <li class="nav-item"> <a class="nav-link" href="{{ url('calculo') }}"> Salario</a>
                                </li>
                                <li class="nav-item"> <a class="nav-link" href="{{ url('#') }}"> CestaTikect
                                    </a></li>
                    ...
                    <li class="nav-item">
                        ...
                        <div class="collapse" id="auth">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item"> <a class="nav-link" href="{{ url('/user') }}"> Listado </a>
                                </li>
                                <li class="nav-item"> <a class="nav-link" href="{{ url('/Registro') }}"> Registrar
                                    </a></li>
                            </ul>
                        </div>
                    </li>
                    ...
                    <li class="nav-item sidebar-user-actions">
                        <div class="sidebar-user-menu">
                            <a href="{{ route('login.destroy') }}" class="nav-link"><i
